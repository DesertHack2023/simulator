...
class Wall:
    ...
    def on_segment(self, a, b, c):
        ...
        return (min(a[0], c[0]) <= b[0] and b[0] <= max(a[0], c[0])) and (
    ...
    def intersects(self, line):
        ...
        # General case
        if (orientations[0] != orientations[1]) and (
    ...
    def distance_to_door(self, point):
        ...
        return sqrt((self_center[0] - point[0]) ** 2 + (self_center[1] - point[1]) ** 2)
    ...
    def vec_to_door(self, point):
        ...
        return ((self_center[0] - point[0]), (self_center[1] - point[1]))
